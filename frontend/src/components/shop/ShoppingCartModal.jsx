...
import OrderSummaryComponent from './OrderSummaryComponent.jsx';
import {removeFromCart, updateQuantity} from '../../redux/features/cart/cartSlice.js';


export default function ShoppingCartModal({products, isOpen, onClose}) {
         ...
         >
            <div className="p-4 mt-4">
               <div className="flex justify-between items-center mb-4">
                  <h4 className="text-xl font-semibold">Your Republic Cart</h4>
                  <button
                     onClick={() => onClose()}
                           ...
                           <div key={index} className='flex flex-col md:flex-row md:items-center md:justify-between shadow-md md:p-5 p-2 mb-4'>
                              <div className='flex items-center'>
                                 ...
                                 <div className='flex flex-row md:justify-start justify-end items-center mt-2'>
                                    <button
                                       onClick={() => handleUpdateQuantity('decrement', item._id)}
                                    ...
                                    <button
                                       onClick={() => handleUpdateQuantity('increment', item._id)}
